...
if __name__ == "__main__":
    ...
    cfg = bytes("/home/nvidia/Documents/NeuralNet/Weights+CFG/V2_Foscam/yolov3-tiny-tennis.cfg", encoding="utf-8")
    weights = bytes("/home/nvidia/Documents/NeuralNet/Weights+CFG/V2_Foscam/V2_Foscam.weights", encoding="utf-8")
    data = bytes("/home/nvidia/Documents/NeuralNet/Weights+CFG/V2_Foscam/obj.data", encoding="utf-8")
